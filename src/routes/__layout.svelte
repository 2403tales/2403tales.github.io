...
<nav class="bg-emerald-500 text-neutral-900 px-2 sm:px-4 py-2 sticky top-0">
    <div class="container flex flex-wrap items-center mx-auto">
      ...
      <div class="text-right grow md:hidden">
        <button data-collapse-toggle="mobile-menu" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-neutral-900 md:hidden" aria-controls="mobile-menu-2" aria-expanded="false">
